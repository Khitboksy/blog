...
date: 2026-06-26
pinned: true
description: A (not so) brief summary of ME!
tags:
  - meta
---
...
I'm a not-so-country not-so-city girl from a small town outside
Galveston Texas. Early 2025 I made the very hard decision to above
across the country to a small town in Tennessee to live with my
amazing girlfriend, Ryn. In early 2026 Some issues between me and her family led
to me having to move all the way back home to Texas after not even a full year. :c  
...
written in `typescript` with a react front-end. I wouldn't say it's complete, nor am i happy with it.
If I'm being honest, its kind of a slop-site.  
A few years back i worked
on a Hearts of Iron IV mod called *NONHORST* that my group would use for
our small games, which was almost entirely `lua`.  
Now i get to officially add `html`, `css`, and `markdown` to this list
thanks to this blog!
